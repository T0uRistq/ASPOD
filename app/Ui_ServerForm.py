...
"}")
        ...
        self.checkColor = QtWidgets.QCheckBox(self.centralwidget)
        self.checkColor.setObjectName("checkColor")
        self.verticalLayout.addWidget(self.checkColor)
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.checkColor.setText(_translate("MainWindow", "Выделить переменные"))
